...
pub fn build_router(state: AppState) -> Router {
    let api = Router::new()
        ...
        .route("/reader3/saveBookSources", post(handlers::save_book_sources))
        ...
        .route("/reader3/searchBook", get(handlers::search_book).post(handlers::search_book))
        .route("/reader3/exploreBook", get(handlers::explore_book).post(handlers::explore_book))
        .route("/reader3/searchBookMulti", get(handlers::search_book_multi).post(handlers::search_book_multi))
        .route("/reader3/getBookshelf", get(handlers::get_bookshelf))
        .route("/reader3/getShelfBook", get(handlers::get_shelf_book).post(handlers::get_shelf_book))
        .route("/reader3/getShelfBookWithCacheInfo", get(handlers::get_shelf_book_with_cache_info))
        .route("/reader3/getBookGroups", get(handlers::get_book_groups).post(handlers::get_book_groups))
        .route("/reader3/saveBookGroup", post(handlers::save_book_group))
        .route("/reader3/saveBookGroupOrder", post(handlers::save_book_group_order))
        .route("/reader3/deleteBookGroup", post(handlers::delete_book_group))
        .route("/reader3/saveBookGroupId", post(handlers::save_book_group_id))
        .route("/reader3/addBookGroupMulti", post(handlers::add_book_group_multi))
        .route("/reader3/removeBookGroupMulti", post(handlers::remove_book_group_multi))
        ...
        .route("/reader3/saveBookProgress", post(handlers::save_book_progress))
        .route("/reader3/getBookInfo", get(handlers::get_book_info).post(handlers::get_book_info))
        .route("/reader3/getChapterList", get(handlers::get_chapter_list).post(handlers::get_chapter_list))
        .route("/reader3/getBookContent", get(handlers::get_book_content).post(handlers::get_book_content))
        .route("/reader3/deleteBookCache", post(handlers::delete_book_cache))
        .route("/reader3/getInvalidBookSources", post(handlers::get_invalid_book_sources))
        .route("/reader3/cacheBookSSE", get(handlers::cache_book_sse).post(handlers::cache_book_sse))
        .route("/reader3/searchBookMultiSSE", get(handlers::search_book_multi_sse))
        .route("/reader3/searchBookSourceSSE", get(handlers::search_book_source_sse))
        .route("/reader3/getAvailableBookSource", get(handlers::get_available_book_source).post(handlers::get_available_book_source))
        .route("/reader3/bookSourceDebugSSE", get(handlers::book_source_debug_sse))
        ...
        .route("/reader3/deleteRssSource", post(handlers::delete_rss_source))
        .route("/reader3/getRssArticles", get(handlers::get_rss_articles).post(handlers::get_rss_articles))
        .route("/reader3/getRssContent", get(handlers::get_rss_content).post(handlers::get_rss_content))
        ...
        .route("/reader3/saveReplaceRule", post(handlers::save_replace_rule))
        .route("/reader3/saveReplaceRules", post(handlers::save_replace_rules))
        .route("/reader3/deleteReplaceRule", post(handlers::delete_replace_rule))
        .route("/reader3/deleteReplaceRules", post(handlers::delete_replace_rules))
        .route("/reader3/getWebdavFileList", get(handlers::get_webdav_file_list))
        .route("/reader3/getWebdavFile", get(handlers::get_webdav_file))
        .route("/reader3/uploadFileToWebdav", post(handlers::upload_file_to_webdav))
        .route("/reader3/deleteWebdavFile", post(handlers::delete_webdav_file))
        .route("/reader3/deleteWebdavFileList", post(handlers::delete_webdav_file_list))
